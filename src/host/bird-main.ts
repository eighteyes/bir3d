...
async function boot() {
  ...
  sliderRow(tunePanel, wr, "spreadAngleDeg", 10, 50, 1);
  sliderRow(tunePanel, wr, "limbLenM", 6, 24, 1);
  sliderRow(tunePanel, wr, "apexBoost", 1, 2, 0.1);
  sliderRow(tunePanel, wr, "rakeBySpeed", 0, 1, 0.05);
  panelSep(tunePanel, "near — flecks");
  sliderRow(tunePanel, wr, "fleckLen", 1, 6, 0.2);
  sliderRow(tunePanel, wr, "shearGain", 0, 3, 0.1);
  sliderRow(tunePanel, wr, "shearRadius", 1, 6, 0.5);
  sliderRow(tunePanel, wr, "fleckTaper", 0, 0.5, 0.02);
  panelSep(tunePanel, "near — filaments");
  sliderRow(tunePanel, wr, "filSegStep", 0.1, 0.5, 0.02);
  panelSep(tunePanel, "wake — helix");
  sliderRow(tunePanel, wr, "wakeEmitRate", 0, 120, 5);
  sliderRow(tunePanel, wr, "wakeLife", 0.3, 3, 0.1);
  sliderRow(tunePanel, wr, "helixGain", 0, 3, 0.1);
  sliderRow(tunePanel, wr, "wakeSeg", 2, 4, 1);
  panelSep(tunePanel, "wake — rings");
  sliderRow(tunePanel, wr, "ringRate", 1, 20, 1);
  sliderRow(tunePanel, wr, "ringGrow", 1, 20, 1);
  sliderRow(tunePanel, wr, "ringLife", 0.5, 4, 0.1);
  sliderRow(tunePanel, wr, "ringSegN", 8, 32, 2);
